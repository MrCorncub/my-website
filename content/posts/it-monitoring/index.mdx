...
<Text sx={{ fontSize: [0.5,1,2], fontWeight: `bold`, color: `heading` }}>
2.1.1.1 | SNMPv1
</Text>
...
<Text sx={{ fontSize: [0.5,2,3], fontWeight: `bold`, color: `heading` }}>
...
<Text sx={{ fontSize: [2, 2, 2], fontWeight: `bold`, color: `heading` }}>
Folgender Befehl wurde im Command Line Interface ausgeführt:</Text><br/><br/>
...
<center>
    <Text sx={{ fontSize: [2, 2, 2], fontWeight: `bold`, color: `heading` }}>
    Verfasser: Bernhard Ebner, Marco Holzer
    </Text>
</center>
